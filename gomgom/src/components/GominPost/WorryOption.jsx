...
const WorryOption = ({ outerImageStyle, handleImageUpload, optionImage, setSelectionContent, placeholder }) => {
  ...
  return (
    <div className="option-group">
      <div className="option-img" style={outerImageStyle} onClick={() => document.getElementById('fileInput1').click()}>
        ...
        <input type="file" id="fileInput1" style={{ display: "none" }} accept="image/*" onChange={handleImageUpload} />
      </div>
      <input
        type="input"
